...
<aside id="sidebar" class="js-sidebar sticky-sidebar">
    ...
    <div class="h-100">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item <?php echo isParentActive(['/daftar-material', '/daftar-upah', '/daftar-alat', '/daftar-pekerjaan'], $currentPath); ?>">
                <a href="#" class="sidebar-link collapsed" data-bs-target="#pages" data-bs-toggle="collapse" aria-expanded="false">
                    <i class="fa-solid fa-chart-pie pe-2"></i>
                    Data Master
                </a>
                <ul id="pages" class="sidebar-dropdown list-unstyled collapse <?php echo isParentActive(['/daftar-material', '/daftar-upah', '/daftar-alat', '/daftar-pekerjaan'], $currentPath) ? 'show' : ''; ?>" data-bs-parent="#sidebar">
                    ...
                    <li class="sidebar-item <?php echo isActive('/daftar-alat', $currentPath); ?>">
                        <a href="/daftar-alat" class="sidebar-link">
                            <span style="margin-left: 30px;">
                                Daftar Alat
                            </span>
                        </a>
